    ...
    <body>
        ...
        <div class = "container">
            ...
            <div class = "row align-items-center mt-1 mt-md-5">
                ...
                <div class = "d-block d-lg-none col-12 col-md-8 mx-md-auto">
            ...
            <div class = "row align-items-center my-0 my-md-5">
                ...
                <div class = "col-lg-8 col-12">
                    ...
                    <p class = "font-weight-bold text-justify">A sociedade conteporânea é marcada pela correria do dia a dia. A sociedade está valorizando mais o tempo e desejando aproveita-lo com atividades mais prazerosas.</p>
                    
                    <p class = "font-weight-bold text-justify">O projeto proposto é modernizar a maneira como as pessoas fazem suas compras no supermercado, trazendo diversos benefícios como: ganho de tempo, modernidade, comodidade e agilidade.</p>

                    <p class = "font-weight-bold text-justify">O site ajudará na otimizaçao do tempo, fazendo com que as horas gastas em filas de mercado sejam convertidas em tempo livre ao usuário que divide seu tempo entre trabalho, cuidar de casa e possivelmente os estudos. O site será de fácil navegabilidade, facilitando as compras. O site contará com a opção de entrega a domicílio, evitando assim o gasto de tempo e o carregamento de cargas pesadas.</p>

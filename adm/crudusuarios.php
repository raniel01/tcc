    ...
    <div class="container">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                	<?php
                		$usuarios = 'SELECT * FROM TB_USUARIO ORDER BY CD_USUARIO ASC';
                    	$resultados = $GLOBALS['con']->query($usuarios);
                    	...
                    	$exibicao = 'SELECT * FROM TB_USUARIO ORDER BY CD_USUARIO ASC LIMIT '.$inicio.', '.$porpagina.'';
			...
			<div class="clearfix">
                ...
                <?php
                  ...
                  for($i=1;$i<=$total_pagina;$i++){
                     ...
                     echo '<li class="page-item active"><a href="?p='.$i.'" style="background-color: '.$cor.'; color: '.$fonte.';">'.$i.'</a></li>';
                  }

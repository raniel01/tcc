<?php  
include("../conexao.php");
//VERIFICAMOS SE ESTA TENTANDO CADASTRAR UM NOVO FABRICANTE
if (isset($_POST['nomefabricante'])) {
	CadastrarFabricante($_POST['nomefabricante']);
}
if (isset($_POST['codigo'])) {
	ExcluirFabricante($_POST['codigo']);
}
if (isset($_POST['cd'])) {
	AtualizarFabricante($_POST['cd'], $_POST['nome']);
}
?>
<!DOCTYPE html>
<html lang="pt-br">
    ...
    <div class="container">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                	<?php
                		$fabricantes = 'SELECT * FROM TB_FABRICANTE ORDER BY CD_FABRICANTE ASC';
                    	$resultados = $GLOBALS['con']->query($fabricantes);
                    	...
                    	$exibicao = 'SELECT * FROM TB_FABRICANTE ORDER BY CD_FABRICANTE ASC LIMIT '.$inicio.', '.$porpagina.'';
                    	$resultado = $GLOBALS['con']->query($exibicao);
                    	
                    	while($fabricante = $resultado->fetch_array()){

...
if(isset($_SESSION['nivel'])!= "GES"){ 
    alert("Acesso restrito, por favor entre como administrador!");
    echo '<script> window.location="loginadm.php";</script>';
}
if(isset($_REQUEST['botaoatualizar'])){
		AtualizarUsuarioTodos($_POST['user'],$_POST['nivel']);
}
if(isset($_REQUEST['botaoeditar'])){
		AtualizarAdmTodos($_POST['user'],$_POST['nivel']);
}
?>
